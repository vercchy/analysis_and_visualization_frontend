        ...
        <>
            ...
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div className="field">
                    ...
                    <input autoComplete="off" name="email" placeholder="Email"  onChange={handleChange} className="input-field" type="text"/>
                </div>
                <div className="field">
                    <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                         fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <input placeholder="Password" name="password"  onChange={handleChange} className="input-field" type="password"/>
                </div>
                <div className="btn">
                    <button
